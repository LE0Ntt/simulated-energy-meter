...
async def async_setup_entry(
    ...
    profiles = {
        CONF_PROFILE_MORNING: _get(entry, CONF_PROFILE_MORNING, DEFAULT_PROFILE_MORNING),
        CONF_PROFILE_DAY:     _get(entry, CONF_PROFILE_DAY,     DEFAULT_PROFILE_DAY),
        CONF_PROFILE_EVENING: _get(entry, CONF_PROFILE_EVENING, DEFAULT_PROFILE_EVENING),
    ...
    coordinator = EnergyMeterCoordinator(
        ...
        presence_extra_watts=_get(entry, CONF_PRESENCE_EXTRA_WATTS, DEFAULT_PRESENCE_EXTRA_WATTS),
        presence_away_factor=_get(entry, CONF_PRESENCE_AWAY_FACTOR, DEFAULT_PRESENCE_AWAY_FACTOR),
    )
