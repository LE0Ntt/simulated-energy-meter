...
async def async_setup_entry(
    ...
    coordinator = EnergyMeterCoordinator(
        ...
        light_entities=_get(entry, CONF_LIGHT_ENTITIES, []),
        light_watts=_get(entry, CONF_LIGHT_WATTS, DEFAULT_LIGHT_WATTS),
    )
